...
Menampilkan source code bot yang dipakai`)
        ...
        case "ai": case "openai": case "chatgpt": case "ask":
          try {
            ...
            const payload = {
              message: text,
              userId: m.sender.replace("@s.whatsapp.net", ""),
            };
            ...
            if (response.ok) {
              ...
              m.reply("Maaf, sepertinya ada yang error saat mengirim permintaan.");
            }
            } catch (error) {
        ...
        case "img": case "ai-img": case "image": case "images": case "dall-e": case "dalle":
          try {
            // tidak perlu diisi apikeynya disini, karena sudah diisi di file key.json
            if (OPENAI_API_KEY === "ISI_APIKEY_OPENAI_DISINI") return reply("Apikey belum diisi\n\nSilahkan isi terlebih dahulu apikeynya di file key.json\n\nApikeynya bisa dibuat di website: https://beta.openai.com/account/api-keys");
